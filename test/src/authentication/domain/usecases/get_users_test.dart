...
import 'package:tdd_tutorials/src/authentication/domain/usecases/get_users.dart';
  ...
  test(
    ...
    () async {
      ...
      when(() => repository.getUsers()).thenAnswer((_) async => const Right(
          (tResponse))); //then answer for async then return for non async (put null for void in right)
